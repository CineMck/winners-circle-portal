...
export const TIER_CONFIGS: Record<MemberTier, TierConfig> = {
  free: {
    ...
    color: '#888888',
    features: ['Access to #general channel', 'View public challenges', 'Basic profile'],
  },
  core: {
    name: 'core',
    label: 'Core Member',
    ...
    color: '#c9a84c',
    features: ['All community channels', 'All challenges', 'Progress tracking', 'Leaderboard access'],
  },
  elite: {
    name: 'elite',
    label: 'Elite Member',
    ...
    color: '#e0c068',
    features: ['Everything in Core', 'Elite-only channels', 'Priority support', 'Monthly hot seat calls'],
  },
  founding: {
    name: 'founding',
    ...
    color: '#ffd700',
    features: ['Everything in Elite', 'Direct access to founders', 'Annual in-person event', 'Founding member badge forever'],
  },
};
